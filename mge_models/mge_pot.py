...
#Load Legacy
legacy_path = data_path + "mge_legacy/cutout_200.4900_-36.6302.fits"
...
# Load Mitzkus data
mitzkus_data_path = data_path + "mge_pot/mass_mge_5102_mitzkus.dat"
...
hdulist.writeto(data_path + 'mge_pot/mge_POT.fits', overwrite=True)
